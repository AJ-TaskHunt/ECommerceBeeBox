<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" CodeBehind="ReturnOrReplace.aspx.cs" Inherits="ECommerceBeeBox.Customer.ReturnOrReplace" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <script>
        function OrderReplaced() {

            Swal.fire({
                title: 'Your Order Relaced in Process',
                        ...
                        <div class="card card-outline-secondary">
                            ...
                            <div class="card-body">
                                <fieldset>
                                    <div class="row mb-3">
                                        <div class="col-lg-12">
                                            <asp:DropDownList ID="ddlReplace" runat="server" CssClass="form-control">
                                                <asp:ListItem Value="0" Text="Select Resone"></asp:ListItem>
                                                <asp:ListItem Value="1" Text="Damaged Product"></asp:ListItem>
                                                <asp:ListItem Value="2" Text="Wrong Product"></asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <div class="mt-1">
                                        <asp:Button ID="btnReturnOrReplace" runat="server" CssClass="btn btn-secondary btn-lg float-right" Text="Replace Order" OnClick="btnReturnOrReplace_Click" />
                                    </div>
                                </fieldset>
