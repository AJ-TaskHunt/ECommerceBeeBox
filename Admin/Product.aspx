<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="ECommerceBeeBox.Admin.Product" EnableEventValidation="false" %>
                            ...
                            <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                     <asp:LinkButton ID="lbtnDeleteButton" runat="server" Text="Delete" CssClass="badge badge-danger" OnClientClick="return confirm('Are you sure You Want to Delete This Product')" CommandArgument='<%# Eval("ProductId") %>' CommandName="delete" CausesValidation="False">
