<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="ECommerceBeeBox.Customer.Payment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ExceptionError(error) {
            ...
            swal.fire("<span style='colot:red;'> " + error + "</span>");
        }

        function Ordered(paymentId) {
            Swal.fire({
                title: 'Thank you for order',
                text: 'Your product ordered successfully!',
                icon: 'success',
                didOpen: () => {
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                                    ...
                                    <div role="form">
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                OnClick="lbCardSubmit_Click" ValidationGroup="card">Confirm Payment</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Order Total: ₹ <% Response.Write(Session["TotalAmount"]); %> </b>
                            <div class="pt-1">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="card"
                                    HeaderText="Fix the following errors" Font-Names="Times New Roman" />
                            </div>
                        </div>
                    </div>
                </div>
