<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="ECommerceBeeBox.Admin.AdminLogin" %>
    ...
    <form id="form1" runat="server">
        <div class="main-wrapper">
            ...
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
                style="background: url(../AdminTemplate/assets/images/big/auth-bg2.jpg) no-repeat center center;">
                <div class="auth-box row">
                    <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(../AdminTemplate/assets/images/big/auth-bg.jpg);">
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="uname">Admin Name</label>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pwd">Admin Password</label>
                                ...
                                <div class="col-lg-12 text-center">
                                    ...
                                    <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="btn btn-block btn-dark" OnClick="btnLogin_Click" />
                                </div>
